    ...
    >
      ...
      <div>
        <Image
          ...
          className="mb-[24px] ml-[24px] w-[180px] md:mb-[48px] md:ml-[48px] md:w-[250px] lg:w-[350px]"
        />
      </div>
      <div className="mx-auto flex max-w-[95%] flex-col items-center justify-evenly gap-x-[16px] gap-y-[32px] text-[clamp(18px,4px_+_1.75vw,20px)] md:flex-row md:items-start lg:max-w-full xl:w-[1296px]">
        {menu.map((menuItem, i) => (
          <MenuList
            key={i}
            dataId={menuItem.id}
